...
I'm a frontend developer passionate about building clean, intuitive interfaces that users love. I focus on responsive design that looks great and works seamlessly across every device.

- 🎨 Strong eye for UI/UX, typography, and visual detail
- 📱 Mobile-first approach to every project
- 🤝 Open to collaboration — hackathons, projects, and open source
- 🌱 Currently deepening my React & full-stack knowledge
...
- Shipping production-ready projects with real users
- Bridging frontend skills into full-stack with Node.js & databases
- Writing cleaner, more maintainable component-driven code
- Building a strong portfolio that speaks louder than a resume
